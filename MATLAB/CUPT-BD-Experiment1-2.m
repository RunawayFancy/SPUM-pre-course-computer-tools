...
legend('Group1-2-1','Group1-2-2','Group1-2-3','Group1-2-4','Group1-2-5','Group1-2-6','Group1-2-7')
xlabel('Time t (s)');
...
dydt = [y(2);1/2*150*sin(2*y(1))-9.81*sin(y(1))/0.1-0.3*y(2)/0.1];
...
dydt = [y(2);1/2*75*sin(2*y(1))-9.81*sin(y(1))/0.2-0.3*y(2)/0.2];
% dydt = [y(2);1/2*w^2*sin(2*y(1))-9.8*sin(y(1))/r-a/r*y(2)];
...
dydt = [y(2);1/2*50*sin(2*y(1))-9.81*sin(y(1))/0.3-0.3*y(2)/0.3];
% dydt = [y(2);1/2*w^2*sin(2*y(1))-9.8*sin(y(1))/r-a/r*y(2)];
...
dydt = [y(2);1/2*37.5*sin(2*y(1))-9.81*sin(y(1))/0.4-0.3*y(2)/0.4];
% dydt = [y(2);1/2*w^2*sin(2*y(1))-9.8*sin(y(1))/r-a/r*y(2)];
...
dydt = [y(2);1/2*30*sin(2*y(1))-9.81*sin(y(1))/0.5-0.3*y(2)/0.5];
% dydt = [y(2);1/2*w^2*sin(2*y(1))-9.8*sin(y(1))/r-a/r*y(2)];
...
dydt = [y(2);1/2*25*sin(2*y(1))-9.81*sin(y(1))/0.6-0.3*y(2)/0.6];
% dydt = [y(2);1/2*w^2*sin(2*y(1))-9.8*sin(y(1))/r-a/r*y(2)];
...
dydt = [y(2);1/2*21.4*sin(2*y(1))-9.81*sin(y(1))/0.7-0.3*y(2)/0.7];
% dydt = [y(2);1/2*w^2*sin(2*y(1))-9.8*sin(y(1))/r-a/r*y(2)];
