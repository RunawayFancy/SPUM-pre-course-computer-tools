...
dydt = [y(2);1/2*19.8*sin(2*y(1))-9.8*sin(y(1))/0.5-0.3*y(2)/0.5];
...
dydt = [y(2);1/2*20*sin(2*y(1))-9.8*sin(y(1))/0.5-0.3*y(2)/0.5];
% dydt = [y(2);1/2*w^2*sin(2*y(1))-9.8*sin(y(1))/r-a/r*y(2)];
...
dydt = [y(2);1/2*20.2*sin(2*y(1))-9.8*sin(y(1))/0.5-0.3*y(2)/0.5];
% dydt = [y(2);1/2*w^2*sin(2*y(1))-9.8*sin(y(1))/r-a/r*y(2)];
...
dydt = [y(2);1/2*20.4*sin(2*y(1))-9.8*sin(y(1))/0.5-0.3*y(2)/0.5];
% dydt = [y(2);1/2*w^2*sin(2*y(1))-9.8*sin(y(1))/r-a/r*y(2)];
...
dydt = [y(2);1/2*20.6*sin(2*y(1))-9.8*sin(y(1))/0.5-0.3*y(2)/0.5];
% dydt = [y(2);1/2*w^2*sin(2*y(1))-9.8*sin(y(1))/r-a/r*y(2)];
...
dydt = [y(2);1/2*20.8*sin(2*y(1))-9.8*sin(y(1))/0.5-0.3*y(2)/0.5];
% dydt = [y(2);1/2*w^2*sin(2*y(1))-9.8*sin(y(1))/r-a/r*y(2)];
